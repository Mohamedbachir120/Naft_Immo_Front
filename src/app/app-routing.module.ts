        ...
        RouterModule.forRoot([
            {
                ...
                children: [
                    ...
                    {path:'SN',component:SnListComponent},
                    {path:'equipes',component:EquipeListComponent},
                    {path:'localites',component:LocaliteListComponent},
                    {path:'decharge_sn',component:DechargesnListeComponent},
                    {path:'decharge_bien',component:DechargebienListComponent},
